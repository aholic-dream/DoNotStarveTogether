...
function GetNextTickPosition(inst, reverse_deg, speedmultiplierx, speedmultiplierz)
...
function DoFakePhysicsWallMovement(inst, speed, canmoveto, getmaxxz, dorealmovement, ...)
    local x, y, z = inst.Transform:GetWorldPosition()
