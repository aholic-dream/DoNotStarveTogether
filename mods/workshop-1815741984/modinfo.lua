name = "[DST]Musha Fixd[The original and beta versions are common]"
version = "T 13.7.8"
description = "[ Version :Unstable version     \nThere are a few errors at the moment, but I try to address them.          \nDon't go back to the old archive too often, which can cause crashes.     \nI'm trying to fix something, and I'll fix it if I can.\nNew updates fix farm problems.\n已经修复了农场问题，原版和测试服通用。\n"
