...
local AURA_EXCLUDE_TAGS = { "toadstool", "playerghost", "ghost", "shadow", "shadowminion", "noauradamage", "INLIMBO", "musha", "yamche", "player" }
...
local function fn()
    ...
    inst.AnimState:SetBuild("sporecloud2")
...
return Prefab("sporecloud2", fn, assets, prefabs),
