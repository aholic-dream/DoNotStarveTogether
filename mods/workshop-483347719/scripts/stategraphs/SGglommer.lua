-- CREDIT: This belongs to Klei, we just borrowed this to make him quieter/louder.
...
local function StartFlap(inst)
	...
	inst.FlapTask = inst:DoPeriodicTask(4*FRAMES, function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC001/creatures/glommer/flap", "buzz") inst.SoundEmitter:SetVolume("buzz", GlommerVolume) end)
end
